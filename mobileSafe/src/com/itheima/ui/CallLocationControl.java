...
public class CallLocationControl extends RelativeLayout {
	...
	public CallLocationControl(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
		init();
	}

	public CallLocationControl(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
		//在布局中初始化自定义的属性
		//先初始化控件然后再初始化空间的属性
	...
	public CallLocationControl(Context context, AttributeSet attrs, int defStyle) {
