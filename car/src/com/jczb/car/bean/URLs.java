 ...
 * @version 1.0
 * @created 2012-3-21
 * 修改内容：注释掉本项目用不到的，添加本项目中用到的一些Url地址静态不可变变量
 * 修改人：吴利昌
 * 修改时间：2015-08-27
 */
...
public class URLs implements Serializable {
	...
	/**url前缀*/
	private static String urlPrefix = "http://192.168.1.110:8080/CheDuanZiApi";
	
	/**url后缀*/
	private static String urlSuffix = ".action";
	
	/**频道列表访问url地址*/
	public final static String CHANNEL_CATEGORY_URL=urlPrefix + "/json_ChannelCategory"+urlSuffix;
	
	/**获取推荐的频道内容信息url地址*/
	public final static String RECOMMEND_CONTENT_URL = urlPrefix +"/json_Content" + urlSuffix;
	
	/**获取各频道内容下的列表信息url地址*/
	public final static String CATEGORY_CONTENT_URL = urlPrefix + "/json_GetContentByCategory"+urlSuffix;
	
	/**获取段子内容详细信息url地址    type=0/1   图文/视频*/
	public final static String PASSAGE_CONTENT_URL = urlPrefix + "/json_GetContentDetail" + urlSuffix;
	public final static String SEARCH_CONTENT_URL = urlPrefix + "/json!SearchIndex.do";
	/**获取验证码的url地址*/
	public final static String VALIDATE_CODE_URL =urlPrefix +"/json_GetCode"+urlSuffix;
	
	/**注册的url地址*/
	public final static String REGISTER_URL = urlPrefix + "/json_AddUser" + urlSuffix;
	
	/**登录的url地址*/
	public final static String LOGIN_URL = urlPrefix + "/json_Login"+urlSuffix;
	
	/**上传头像的url地址*/
	public final static String UPLOAD_IMG_URL = urlPrefix + "/json_uploadHead" + urlSuffix;
	
	/**修改昵称的url地址*/
	public final static String UPDATE_NICKNAME_URL = urlPrefix + "/json_UpdateNickname" + urlSuffix;
	
	/**修改密码的url地址*/
	public final static String UPDATE_PWD_URL = urlPrefix + "/json_UpdatePassword" + urlSuffix;
	
	/**发现的url地址*/
	public final static String DISCOVER_URL = urlPrefix + "/json_Search" + urlSuffix;
	
	/**我的收藏的url地址*/
	public final static String MYCOLLECTION_URL = urlPrefix + "/json_Mycollect" + urlSuffix;
	
	/**我的评论的url地址*/
	public final static String MYCOMMENT_URL = urlPrefix + "/json_Mycomment" + urlSuffix;
	
	/**频道内容评论的url地址*/
	public final static String CHANNELCONTENT_COMMENT_URL = urlPrefix + "/json_Allcomment" + urlSuffix;
	
	/**版本信息的url地址*/
	public final static String VERSION_URL = urlPrefix + "/json_Version" + urlSuffix;
	
	/**添加评论的url地址*/
	public final static String ADD_COMMENT_URL = urlPrefix + "/json_AddComment" + urlSuffix;
	
	//public final static String test="http://192.168.1.112:8080/CheDuanZiApi/json_Content.action";//首页楼层内容
	
	//--------------------------------------暂时用不到的-------开始--------------------------------
	public final static String HOST = "192.168.0.112";//192.168.1.213  www.oschina.net
	...
	//内容列表地址
	public final static String CONTENT_LIST = URL_API_HOST+"action/api/blog_list";
	//public final static String test="http://192.168.1.110:8080/SchoolShopJson/ShoppingCart.txt";
