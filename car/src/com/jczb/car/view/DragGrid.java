package com.jczb.car.view;


import com.jczb.car.R;
import com.jczb.car.adapter.DragAdapter;
import com.jczb.car.tool.DataTools;
	...
	public void setOnItemClickListener(final MotionEvent ev) {
		setOnItemLongClickListener(new OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> parent, View view,
				...
				dragTextView.setSelected(true);    //item选中之后相应的操作
...
//					mVibrator.vibrate(50);//设置震动时间
					...
					hideDropItem(); 
					dragViewGroup.setVisibility(View.INVISIBLE);  //设置控件不可见 
					isMoving = false;
